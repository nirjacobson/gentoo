...
DESCRIPTION="VGM composer"

# Homepage, not used by Portage directly but handy for developer reference
HOMEPAGE="https://nirjacobson.com/chromasound"

# Point to any required sources; these will be automatically downloaded by
# Portage.
EGIT_REPO_URI="https://github.com/nirjacobson/Chromasound-Studio.git"
...
src_install() {
	cmake_src_install
	install ${FILESDIR}/lxqt-applications.menu /etc/xdg/menus/lxqt-applications.menu
}
